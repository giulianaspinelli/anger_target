package targetExtraction.frasi_lowercase;
...
public class R1b_lc {
		...
		public static void main(String[] args) throws Exception { 
			...
			BufferedReader br = new BufferedReader(new FileReader("C:/Users/giuli/Desktop/grammatical_dep_lowercase.txt")); //sentence_grammatical		
			BufferedReader br_2 = new BufferedReader(new FileReader("C:/Users/giuli/Desktop/dependencies_lowercase.txt")); // 

			String line = br.readLine();
			String line_2 = br_2.readLine();
			
			File fout = new File("risultati_regole/r1b_lc.csv"); //
